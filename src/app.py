...
activities = {
    ...
    "Basketball League": {
        "description": "Team basketball training and intramural league play",
    ...
    "Drama Club": {
        "description": "Acting workshops and stage productions for all skill levels",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions and hands-on STEM challenges",
